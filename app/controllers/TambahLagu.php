    ...
    public function index(){
        ...
        if (isset($_SESSION["isAdmin"]) and $_SESSION["isAdmin"] == 1) {
            ...
            if (isset($_FILES["lagu"]) and isset($_FILES["file"]) and isset($_POST["album"]) and isset($_POST["judul"]) and isset($_POST["penyanyi"]) and isset($_POST["tanggalterbit"]) and isset($_POST["genre"]) and isset($_POST["durasi-lagu"])) {
                if ($_POST["album"] >= 0 and $_FILES["lagu"] != "" and $_POST["judul"] != "" and $_POST["tanggalterbit"] != "" and $_POST["genre"] != "" and $_POST["durasi-lagu"] != "") {
                    ...
                    $this->model('album_model')->updateAlbum($_POST["album"]);
                    unset($_FILES["lagu"]);
                    unset($_FILES["file"]);
                    header('Location: ' . BASEURL . '/tambahlagu');
                } else if ($_POST["album"] == -1 and $_FILES["file"] != "" and $_FILES["lagu"] != "" and $_POST["judul"] != "" and $_POST["penyanyi"] != "" and $_POST["tanggalterbit"] != "" and $_POST["genre"] != "" and $_POST["durasi-lagu"] != "") {
